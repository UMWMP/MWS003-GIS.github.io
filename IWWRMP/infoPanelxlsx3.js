...
function displayTable(data) {
    ...
    keys.forEach((key, index) => {
        ...
        filterSelect.addEventListener('change', function () {
            applyDropdownFilter(index, filterSelect.value);
        });

        const filterRow = headerRow.insertCell();
...
function applyDropdownFilter(columnIndex, selectedValue) {
